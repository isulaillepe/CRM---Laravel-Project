    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="font-semibold text-xl text-zinc-900 tracking-tight">Initiate Proposal</h2>
                    <p class="text-xs text-zinc-500 mt-1">Configure and assign a commercial proposal to an existing customer profile.</p>
                </div>
                <Link 
                ...
                <div class="bg-white rounded-lg border border-zinc-200 p-6 md:p-8">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Proposal Status -->
                            <div>
                                <label class="block text-[10px] font-semibold uppercase tracking-wider text-zinc-400">Initial Status</label>
                                <select 
                                    v-model="form.status" 
                                    required
                                    class="mt-1.5 block w-full rounded-lg border-zinc-200 hover:border-zinc-300 focus:border-blue-600 focus:ring-1 focus:ring-blue-600 text-xs py-2 transition"
