    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="font-bold text-2xl text-gray-900 tracking-tight">Edit Proposal</h2>
                    <p class="text-sm text-gray-500 mt-1">Modify proposal configuration and change deal status.</p>
                </div>
                <Link 
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-xs font-semibold uppercase tracking-wider text-gray-500">Proposal Status</label>
                                <select 
                                    v-model="form.status" 
                                    required
                                    class="mt-2 block w-full rounded-xl border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm py-2.5 transition duration-150"
