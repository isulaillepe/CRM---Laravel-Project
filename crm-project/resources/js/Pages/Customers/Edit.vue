    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="font-semibold text-2xl text-zinc-900 tracking-tight">Edit Customer</h2>
                    <p class="text-xs text-zinc-500 mt-1">Modify customer configuration and database details.</p>
                </div>
                <Link 
